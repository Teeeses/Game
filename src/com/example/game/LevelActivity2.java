...
public class LevelActivity2 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MainActivity.someOpenLevelList = 2;
	...
	public void onClick(View v) 
	{
		if (howManyClick == false) {
			...
			case R.id.buttonRight:
				i = new Intent(this, LevelActivity3.class);
				this.finish();
				break;
	...
	{	
		...
		{
			if(MainActivity.availableLevel >= (numberButtons + i + 1))
			{
				arrayButtons[i].setTextSize(18);
				arrayButtons[i].setBackgroundResource(R.drawable.box_button);
				arrayButtons[i].setText(Integer.toString(numberButtons + i + 1));
			}
			else
			{
